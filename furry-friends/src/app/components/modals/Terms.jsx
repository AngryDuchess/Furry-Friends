  ...
  return (
    <>
      <div className="max-w-xl mx-auto">
        <Modal dismissible show={isOpen} onClose={onClose} size="xl" position="top-center">
            ...
            <div className="text-dark text-sm space-y-4 p-4">
              ...
              >
                ...
                <li className="flex flex-col gap-1">
                  <p>13. Contact Us</p>
                  <p className="font-normal">
                  If you have any questions about these Terms and Conditions, please contact us at <a className="text-bluebase hover:underline"  href="https://www.gmail.com">mahamahamida@gmail.com</a>
                  </p>
                </li>
              </ol>
            </div>
