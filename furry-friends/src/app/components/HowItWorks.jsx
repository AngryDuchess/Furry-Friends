  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/dn5ks1ljf/image/upload/v1716588251/FurryFriends/second-bg_fkbbeg.png')",
        ...
        <div className="flex flex-col gap-12 lg:flex-row items-center justify-between">
            <div className="flex flex-col justify-center gap-4 items-center w-full max-w-[334px]">
                <div className="flex items-center justify-center rounded-full bg-palegreen w-[172px] h-[172px]">
                    <Image alt={'cat-phone'} width={200} height={200} className="h-[122px] w-auto" src="https://res.cloudinary.com/dn5ks1ljf/image/upload/v1716588238/FurryFriends/cat-phone_df1sxq.svg" />
                </div>
            ...
            <div className="flex flex-col justify-center gap-4 items-center w-full max-w-[334px]">
                <div className="flex items-center justify-center rounded-full bg-accentpalest w-[172px] h-[172px]">
                    <Image alt={'cat-dog'} width={200} height={200} className="h-[122px] w-auto" src="https://res.cloudinary.com/dn5ks1ljf/image/upload/v1716588239/FurryFriends/cat-dog_kye9au.svg" />
                </div>
                <div className="text-center text-dark flex flex-col gap-3">
            ...
            <div className="flex flex-col justify-center gap-4 items-center w-full max-w-[334px]">
                <div className="flex items-center justify-center rounded-full bg-secondarypale w-[172px] h-[172px]">
                    <Image width={200} height={200}  alt={'boss dog'} className="h-[122px]" src="https://res.cloudinary.com/dn5ks1ljf/image/upload/v1716588238/FurryFriends/boss-dog_fminzh.svg" />
                </div>
                <div className="text-center text-dark flex flex-col gap-3">
                    <p className="font-semibold text-accent">Book a Call & Receive Your Pet</p>
                    <p>Schedule a call to finalize the adoption. Then, get ready to welcome your new furry friend home!</p>
                </div>
            </div>
        </div>
      </section>
